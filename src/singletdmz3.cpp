...
double SingletDMZ3_RD::cs_integral(double s, double T)
{
...
// vector bosons
double SingletDMZ3_RD::sigma_v_VV(double s)
{
double result=0;
...
// fermions
double SingletDMZ3_RD::sigma_v_ff(double s)
{
double result;
...
// Higgs
double SingletDMZ3_RD::sigma_v_hh(double s)
{
double result;
...
double SingletDMZ3_RD::sigma_v(double s)
{
double sigv;
...
double SingletDMZ3_RD::Dh2(double s)
{
...
double SingletDMZ3_RD::gamma_h(double x)
{
